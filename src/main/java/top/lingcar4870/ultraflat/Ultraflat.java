...
import top.lingcar4870.ultraflat.worldgen.UltraflatEndChunkGenerator;
...
public class Ultraflat implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        Registry.register(Registries.CHUNK_GENERATOR, Identifier.of(MODID, "ultra_flat_end"), UltraflatEndChunkGenerator.CODEC);
